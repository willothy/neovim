...
--- `win` is provided, a window will be created adjacent to the current
--- window. If -1 is provided, a top-level split will be created. `vertical`
--- and `split` are only valid for normal windows, and are used to control
--- split direction. Split windows cannot have
